      ...
      <div className="min-h-screen bg-gray-50 text-gray-900">
        ...
        <main className="mx-auto max-w-4xl px-6 py-16 lg:px-8">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-700">
            Ask a focused question about my experience. Answers use the same structured CV data exposed through my public MCP server and are constrained to what the CV actually supports.
          </p>
